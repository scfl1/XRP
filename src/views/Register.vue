    ...
    <div class="card">
      ...
      <div class="brand-header">
        <div class="logo-wrapper">
          <img :src="logo" class="luxury-logo" alt="Nova Demo Logo" />
        </div>
      </div>
...
<style scoped>
/* NOVA DESIGN SYSTEM — REGISTER */
.container{min-height:100vh!important;display:grid!important;place-items:center!important;padding:28px 18px!important;background:radial-gradient(circle at 12% 12%,rgba(49,196,255,.13),transparent 32%),radial-gradient(circle at 90% 80%,rgba(114,87,255,.20),transparent 32%),#070914!important;position:relative;overflow:hidden}.container:before{content:"";position:absolute;inset:0;background-image:linear-gradient(rgba(255,255,255,.025) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.025) 1px,transparent 1px);background-size:34px 34px;pointer-events:none}.card{position:relative;z-index:1;width:min(100%,500px)!important;padding:34px!important;border-radius:28px!important;background:rgba(15,19,36,.90)!important;border:1px solid rgba(169,140,255,.20)!important;box-shadow:0 28px 80px rgba(0,0,0,.45)!important;backdrop-filter:blur(20px)}.logo-wrapper{width:78px!important;height:78px!important;margin:auto!important;border-radius:24px!important;background:linear-gradient(145deg,#31c4ff,#7257ff)!important;box-shadow:0 12px 34px rgba(49,196,255,.22)!important}.luxury-logo{width:54px!important;height:54px!important;filter:brightness(0) invert(1)!important}.title{font-size:28px!important;color:#fff!important;font-weight:900!important}.title:after{content:'Nova Demo • تجربة';display:block;margin-top:8px;color:#8f9ab8;font-size:12px;font-weight:600}.register-type-selector{background:#0b1020!important;padding:6px!important;border-radius:16px!important;border:1px solid rgba(255,255,255,.05)!important}.type-btn{border-radius:11px!important;color:#8f9ab8!important}.type-btn.active{background:linear-gradient(135deg,#7257ff,#31c4ff)!important;color:#fff!important}.input,.phone-input,.country-select{height:50px!important;border-radius:15px!important;background:#0b1020!important;border-color:rgba(169,140,255,.16)!important;color:#fff!important}.input:focus,.phone-input:focus,.country-select:focus{border-color:#8f76ff!important;box-shadow:0 0 0 4px rgba(114,87,255,.12)!important}.btn{height:52px!important;border-radius:15px!important;background:linear-gradient(135deg,#7257ff,#9b7cff)!important;color:#fff!important;box-shadow:0 12px 26px rgba(114,87,255,.22)!important}.link a{color:#a98cff!important}.error-message-box{border-radius:14px!important;background:rgba(255,82,112,.08)!important;border:1px solid rgba(255,82,112,.22)!important}
</style>
