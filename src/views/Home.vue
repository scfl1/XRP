          ...
          <div class="modal-body">
            <div class="company-text">
              <p>
                ...
                يسرّنا أن نعرفكم بشركة Nova Demo التي تأسست في إنجلترا بتاريخ 5 فبراير 2026، وهي شركة استثمارية متخصصة في مجال التجارة الإلكترونية. تمتلك الشركة فريقاً تقنياً محترفاً وخبرة مالية قوية، ويقع مقرها الرئيسي حالياً في منطقة الأعمال المركزية في إنجلترا.<br><br>
                ...
                نحن في Nova Demo نؤمن بأن النجاح الحقيقي يجب أن يكون متاحاً للجميع، لذلك تم تصميم هذا المشروع ليكون فرصة متاحة لكل الناس، وخاصة للطبقة المتوسطة وذوي الدخل المحدود، حتى يتمكنوا من تحسين أوضاعهم والمشاركة في فرص الاقتصاد الرقمي.<br><br>
                ...
                نتمنى للجميع التوفيق، ونسعد بانضمامكم إلى مجتمع Nova Demo 🌴
              </p>
            </div>
  ...
  data() {
    return {
      ...
      reviewsList: [
        ...
        { name: "عمر سعيد", country: "🇶🇦", rating: 5, message: "سحبت أرباحي بكل سهولة، شكراً لفريق Nova Demo" },
...
<style scoped>
/* NOVA DESIGN SYSTEM — HOME */
.home-container{min-height:100vh!important;background:radial-gradient(circle at 85% 0%,rgba(114,87,255,.17),transparent 26%),radial-gradient(circle at 5% 55%,rgba(49,196,255,.08),transparent 24%),#070914!important;color:#fff!important}.app-header{background:linear-gradient(180deg,rgba(12,16,32,.98),rgba(12,16,32,.80))!important;border-bottom:1px solid rgba(169,140,255,.10)!important;backdrop-filter:blur(18px)}.menu-btn,.notif-btn,.refresh-btn{background:#0f1529!important;color:#a98cff!important;border-color:rgba(169,140,255,.12)!important}.balance-display{background:#0f1529!important;border:1px solid rgba(169,140,255,.12)!important;border-radius:18px!important}.balance-label,.welcome-text{color:#8f9ab8!important}.balance-value .amount,.user-name{color:#fff!important}.currency{color:#72d8ff!important}.balance-card,.action-card,.stat-card,.section-card{background:linear-gradient(145deg,#151a31,#0e1326)!important;border:1px solid rgba(169,140,255,.14)!important;border-radius:22px!important;box-shadow:0 16px 38px rgba(0,0,0,.20)!important}.card-title,.action-title,.section-title{color:#fff!important}.card-amount{color:#a98cff!important}.action-subtitle{color:#8f9ab8!important}.card-icon-wrapper,.action-card .icon-wrapper{background:rgba(114,87,255,.12)!important;color:#a98cff!important;border-color:rgba(169,140,255,.16)!important}.withdrawable-card{border-color:rgba(49,196,255,.18)!important}.upgrade-card{border-color:rgba(114,87,255,.18)!important}.sidebar{background:#0b1020!important;border-color:rgba(169,140,255,.14)!important}.sidebar-nav a{color:#aeb8d0!important}.sidebar-nav a:hover{background:rgba(114,87,255,.10)!important;color:#fff!important}.custom-modal-container{background:#101528!important;border-color:rgba(169,140,255,.20)!important}.custom-modal-header{background:linear-gradient(135deg,#7257ff,#31c4ff)!important;color:#fff!important}.modal-gold-line{background:linear-gradient(90deg,transparent,#a98cff,transparent)!important}.main-gold-btn,.submit-review-btn{background:linear-gradient(135deg,#7257ff,#9b7cff)!important;color:#fff!important}.toast-notification{background:#101528!important;border-color:rgba(169,140,255,.16)!important}.toast-progress{background:linear-gradient(90deg,#7257ff,#31c4ff)!important}
</style>
