...
<style scoped>
/* NOVA DESIGN SYSTEM — PROFILE */
.profile-page{min-height:100vh!important;padding:26px 16px 110px!important;background:radial-gradient(circle at 85% 8%,rgba(114,87,255,.16),transparent 28%),#070914!important;color:#fff!important}.profile-container{max-width:720px!important;margin:auto!important}.profile-header{padding:30px 22px!important;border-radius:28px!important;background:linear-gradient(145deg,rgba(20,26,49,.96),rgba(12,16,31,.96))!important;border:1px solid rgba(169,140,255,.18)!important;box-shadow:0 24px 60px rgba(0,0,0,.3)!important}.avatar-circle{border:2px solid rgba(169,140,255,.5)!important;background:linear-gradient(145deg,#7257ff,#31c4ff)!important;box-shadow:0 14px 30px rgba(114,87,255,.25)!important}.username-display{color:#fff!important;font-weight:900!important}.user-email{color:#8f9ab8!important}.fields-section{margin-top:16px!important;padding:22px!important;border-radius:24px!important;background:rgba(15,19,36,.82)!important;border:1px solid rgba(169,140,255,.14)!important;box-shadow:0 16px 40px rgba(0,0,0,.18)!important}.section-label{color:#e9ecf6!important;border-bottom-color:rgba(255,255,255,.06)!important}.section-label i{color:#a98cff!important}.gold-field label{color:#8f9ab8!important}.gold-input-field{background:#0b1020!important;border-color:rgba(169,140,255,.12)!important;color:#fff!important;border-radius:13px!important}.field-action-btn{background:rgba(114,87,255,.12)!important;color:#a98cff!important;border-color:rgba(169,140,255,.18)!important;border-radius:11px!important}.balance-text{color:#fff!important}.currency-tag{background:rgba(49,196,255,.12)!important;color:#72d8ff!important;border-color:rgba(49,196,255,.2)!important}.action-buttons{gap:10px!important}.main-gold-btn{background:linear-gradient(135deg,#7257ff,#9b7cff)!important;color:#fff!important;border:0!important;border-radius:15px!important;box-shadow:0 10px 24px rgba(114,87,255,.18)!important}.outline-gold-btn{background:transparent!important;color:#a98cff!important;border:1px solid rgba(169,140,255,.28)!important;border-radius:15px!important}.danger-btn{border-radius:15px!important;background:rgba(255,82,112,.08)!important;color:#ff8299!important;border:1px solid rgba(255,82,112,.20)!important}.gold-spinner{border-color:#7257ff transparent #31c4ff transparent!important}
</style>
