    ...
    <div class="card">
      ...
      <div class="brand-header">
        <div class="logo-wrapper">
          <img :src="logo" class="luxury-logo" alt="Nova Demo" />
        </div>
      </div>
  ...
  <div id="companyAd" class="ad-overlay" v-if="showAd">
    <div class="ad-box">
      ...
      <div class="ad-content">
        <p>مرحباً بك في Nova Demo.<br><br>هذه نسخة تجريبية لواجهة التطبيق، والغرض منها استعراض التصميم وتجربة تدفق الحساب والصفحات. لا تمثل الأرصدة أو المستويات أو النتائج المعروضة استثماراً حقيقياً أو وعداً بعائد مالي.<br><br>يمكنك تجربة التسجيل والدخول واستعراض الواجهة بأمان ضمن بيئة Demo.</p>
      </div>
...
<style scoped>
/* NOVA DESIGN SYSTEM — AUTH */
.container{min-height:100vh!important;display:grid!important;place-items:center!important;padding:28px 18px!important;background:radial-gradient(circle at 15% 10%,rgba(114,87,255,.20),transparent 34%),radial-gradient(circle at 90% 85%,rgba(49,196,255,.12),transparent 30%),#070914!important;position:relative;overflow:hidden}
.container:before{content:"";position:absolute;inset:0;background-image:linear-gradient(rgba(255,255,255,.025) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.025) 1px,transparent 1px);background-size:34px 34px;mask-image:linear-gradient(to bottom,black,transparent);pointer-events:none}
.card{position:relative;z-index:1;width:min(100%,460px)!important;padding:34px!important;border:1px solid rgba(169,140,255,.20)!important;border-radius:28px!important;background:rgba(15,19,36,.88)!important;box-shadow:0 28px 80px rgba(0,0,0,.45),0 0 0 1px rgba(255,255,255,.025) inset!important;backdrop-filter:blur(20px)}
.brand-header{margin-bottom:18px!important}.logo-wrapper{width:78px!important;height:78px!important;margin:auto!important;border-radius:24px!important;display:grid!important;place-items:center!important;background:linear-gradient(145deg,#7257ff,#31c4ff)!important;box-shadow:0 12px 34px rgba(114,87,255,.30)!important}.luxury-logo{width:54px!important;height:54px!important;object-fit:contain!important;filter:brightness(0) invert(1)!important}.title{font-size:28px!important;font-weight:900!important;color:#fff!important;letter-spacing:-.6px}.title:after{content:'Nova Demo • تجربة';display:block;margin-top:8px;color:#8f9ab8;font-size:12px;font-weight:600;letter-spacing:.2px}
.label{color:#c7cee0!important;font-weight:700!important}.input,.phone-input,.country-select{height:50px!important;border-radius:15px!important;border:1px solid rgba(169,140,255,.16)!important;background:#0b1020!important;color:#fff!important}.input:focus,.phone-input:focus,.country-select:focus{border-color:#8f76ff!important;box-shadow:0 0 0 4px rgba(114,87,255,.12)!important}.login-type-selector,.register-type-selector{gap:8px!important;background:#0b1020!important;padding:6px!important;border-radius:16px!important;border:1px solid rgba(255,255,255,.05)!important}.type-btn{border-radius:11px!important;color:#8f9ab8!important}.type-btn.active{background:linear-gradient(135deg,#7257ff,#31c4ff)!important;color:#fff!important;box-shadow:0 8px 20px rgba(114,87,255,.2)!important}.btn{height:52px!important;border-radius:15px!important;background:linear-gradient(135deg,#7257ff,#9b7cff)!important;color:#fff!important;box-shadow:0 12px 26px rgba(114,87,255,.22)!important}.google-btn{height:50px!important;border-radius:15px!important;background:#fff!important;color:#101425!important;border:0!important}.link a{color:#a98cff!important}.error-message-box{border-radius:14px!important;background:rgba(255,82,112,.08)!important;border:1px solid rgba(255,82,112,.22)!important}.ad-box{background:#101528!important;border-color:rgba(169,140,255,.25)!important}.ad-box h2{background:linear-gradient(135deg,#7257ff,#31c4ff)!important;color:#fff!important}
</style>
