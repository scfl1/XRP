        ...
        <div class="support-menu-body">
          ...
          <div class="support-item" @click="openWhatsApp">
            ...
            <div class="support-info">
              <span class="support-name">{{ t('whatsapp') }}</span>
              <span class="support-desc">{{ t('quickContact') }}</span>
            </div>
          ...
          <div class="support-item" @click="openTelegram">
            ...
            <div class="support-info">
              <span class="support-name">{{ t('telegram') }}</span>
              <span class="support-desc">{{ t('supportCommunity') }}</span>
            </div>
          ...
          <div class="support-item" @click="openTelegramChannel">
            ...
            <div class="support-info">
              <span class="support-name">{{ t('communityChannel') }}</span>
              <span class="support-desc">XRP Community</span>
            </div>
        ...
        <div class="modal-container blocked-modal" @click.stop>
          ...
          <div class="blocked-body">
            ...
            <div class="blocked-info">
              <div class="info-item">
                <i class="fas fa-headset"></i>
                <span>{{ t('contactSupportReview') }}</span>
              </div>
            </div>
          ...
          <div class="modal-body">
            ...
            <div class="offer-content">
              ...
              <div class="offer-title">
                <span class="xrp-title-symbol">X</span>
                <span>{{ t('welcomeXrp') }}</span>
              </div>
        ...
        <div class="modal-container ad-container" @click.stop>
          ...
          <div class="ad-header">
            ...
            <div class="ad-title">
              ...
              <span class="header-xrp-symbol">X</span>

              <span>XRP Community</span>
          ...
          <div class="ad-body">
            ...
            <div class="company-message">
              ...
              <div class="message-header">
                ...
                <span class="message-xrp-icon">X</span>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      /*
       * ضع روابط مجتمعك هنا إذا كان لديك روابط رسمية خاصة بك.
       * لا تستخدم هذه الروابط للإيحاء بأنها حسابات رسمية لـ XRP أو Ripple.
       */
      ...
      translations: {
        ...
        AR: {
          ...
          blockedMessage: "تم حظر حسابك من قبل الإدارة",
          contactSupportReview: "يرجى التواصل مع الدعم لمراجعة حالة حسابك",
          contactSupport: "التواصل مع الدعم",
          logout: "تسجيل الخروج",

          communityUpdate: "تحديث المجتمع",
        ...
        EN: {
          ...
          blockedMessage: "Your account has been blocked by the administration.",
          contactSupportReview: "Please contact support to review your account status.",
  ...
  methods: {
    ...
    onDrag(event) {
      ...
      if (
        deltaX > this.clickThreshold ||
        deltaY > this.clickThreshold
      ) {
