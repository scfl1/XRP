...
export const NETWORKS: NetworkOption[] = [
  ...
  { code: "AVAX",     name: "AVAX",         chain: "AVAX-C",              feeUsd: 0.00045,  feeToken: "0.00045 AVAX",     color: "#E84142" },
  { code: "OPBNB",    name: "OPBNB",        chain: "opBNB",               feeUsd: 0.000001, feeToken: "<0.000001 BNB",    color: "#F0B90B" },
  ...
  { code: "POLYGON",  name: "POLYGON",      chain: "Polygon",             feeUsd: 0.004721, feeToken: "0.004721 USDT",    color: "#8247E5" },
  { code: "SOL",      name: "SOL",          chain: "Solana",              feeUsd: 0.35,     feeToken: "0.346582 USDT",    color: "#14F195" },
  { code: "CELO",     name: "CELO",         chain: "CELO",                feeUsd: 0.004309, feeToken: "0.004309 USDT",    color: "#35D07F" },
];
