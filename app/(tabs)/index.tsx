    ...
    <ScreenContainer className="px-5" edges={["top", "left", "right"]}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <View style={styles.greetingRow}>
          <View><Text style={styles.eyebrow}>صباح الخير، أحمد</Text><Text style={styles.welcome}>إليك نظرة سريعة على محفظتك</Text></View>
        ...
        <Card style={styles.assetCard}>
          ...
          <Text style={styles.assetValue}>{hidden ? "••••••" : "$2,394.23"}</Text>
          <View style={styles.assetBottom}><View style={styles.changeBadge}><MaterialIcons name="trending-up" size={15} color={CWAAX.white}/><Text style={styles.changeText}>+4.68% اليوم</Text></View><Text style={styles.assetSub}>≈ 0.0358 BTC</Text></View>
